...
## สำรับที่ใช้ในเกมปัจจุบัน

เกมใหม่ใช้เฉพาะการ์ดที่รองรับการเล่นในระบบ (ปัจจุบัน 184 ใบ) ส่วนคลังการ์ดยังคงแสดงชุดเต็ม 289 ใบ การ์ดที่ยังขาดหน้าต่างเลือก ผลการ์ดบางส่วน หรือการเชื่อมเหตุการณ์ Trap จะพักออกจากสำรับจนกว่าจะพัฒนาครบ ห้องที่เริ่มไปแล้วต้องเริ่มเกมใหม่เพื่อใช้สำรับนี้

เมื่อกองจั่วหมด ระบบจะรอให้ผลการ์ดและการตอบโต้เสร็จก่อนจบเกม โดยผู้ที่มีจำนวนไพ่ใกล้ 10 ที่สุดชนะร่วมกันได้ ไพ่กองทิ้งจะไม่ถูกสับกลับโดยอัตโนมัติ

บอตใช้กติกาจั่วหรือเล่น Action อย่างใดอย่างหนึ่งเหมือนผู้เล่น และจะไม่เล่น Action ที่ต้องให้คนระบุผลกิจกรรมหรือรายชื่อผู้เล่น
