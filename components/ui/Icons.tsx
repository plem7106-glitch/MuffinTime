...
export function RefreshIcon({
  ...
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`${spinning ? 'animate-spin' : ''} ${props.className || ''}`}
      aria-hidden="true"
      {...props}
    >
      <path d="M21.5 2v6h-6" />
...
export function EnterDoorIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MusicOffIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function VolumeOffIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <line x1="1" y1="1" x2="23" y2="23" />
      <path d="M9 9v6l5 4V5L9 9H5a2 2 0 0 1-2-2V7" />
...
export function ClockwiseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CounterClockwiseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CardStackIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="2" y="7" width="14" height="15" rx="2" />
      <path d="M6 3h12a2 2 0 0 1 2 2v13" />
      <path d="M9 1h11a2 2 0 0 1 2 2v12" />
    </svg>
  );
}
